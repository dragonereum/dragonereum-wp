...
However, this approach is easily exploitable by smart contract. We this function can be called only by user controlled account.\par
...
%\addcontentsline{toc}{subsection}{Gradual decentralization}
