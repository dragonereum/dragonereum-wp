...
Our long-term goal is to create a fully decentralized game, leveraging all of the unique advantages of the blockchain. More on this in Section \ref{Serverless application}.\par
...
\begin{samepage}
 Based on the battle tactics, settings and results of the random number generator (RNG), dragons are able to:\par
 \begin{itemize}
...
Additionally, we want to mention that the proposed RNG is in reality a pseudorandom number generator (PRNG) and true randomness is currently unachievable on the blockchain. Therefore, for high value transactions we offer a solution which minimizes the chances of exploiting the game’s algorithms.\par
...
Our solution uses a block’s hash to generate random numbers. As every transaction relies on different input data (dragon genetics, battle skills and tactics, etc), different dragons will receive different results even if several transactions are included in one block and therefore have the same random number,\par
...
If a player chooses to inbreed close relatives there is a high probability for a negative mutation to occur. This probability depends on different cases and is:\par
...
This can be illustrated by the following example in  Table \ref{tab:An example, illustrating the calculation of the basic skill for a specific body part - the Ashed Legs at level 3 of a particular dragon.}.  The numbers in the last column will be added to other body parts and the result will show the dragon’s aptitude in different basic skills.
...
The maximum Level Up for a dragon is 10. On the 10th Level Up, the player can obtain a \textit{special peaceful skills} for their dragon\footnote{As of December 25, 2018 there has been an update to the recovery time of the \it{special peaceful skills}, which is now set to 14 days.  This was done to fix a flaw, which allowed for these powerful skills to have a low price on the marketplace due to their fast recovery and as a result their high supply.  More details can be found in the following Medium article: \href{https://medium.com/@dragonereum/game-balance-fix-special-peaceful-skills-edition-ee48e6fd7525}{\textcolor[HTML]{1155CC}{\uline{https://medium.com/@dragonereum/game-balance-fix-special-peaceful-skills-edition-ee48e6fd7525}}} .}.\par
...
Additionally, due to the early adopter advantage, it will be easier for those players who start participating in the game from its launch to earn Gold by entering the leaderboard.
...
Our simulation shows that if the dragon population will reach 100k of dragons, and even if just a small part of players will play the game, it is highly unlikely that the Ethereum Foundation network will be able to process those transactions even taking into account potential block gas limit growth according to the Moore's Law in the following years.\par

Therefore, there are several embedded mechanisms to ensure that the dragon population will be within the limits set by the game design (as described in Section \ref{Game Design Constraints}).\par
...
Additionally, once the 10,000th dragon is hatched, another game mechanism will come into play: half of Gold paid for each new incubation will be permanently destroyed by the Nest.\par

Given that the cost of incubation is 1000 GOLD, 500 GOLD will be burned each time a new egg is sent to the Nest. This will increase the price of the next incubation and will limit the theoretical supply of dragons at the level of 129,999 dragons (with the remainder of 500 GOLD in the Treasury). Nonetheless, we think that this theoretical cap will not likely be reached.\par
...
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 15900}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 22650000}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 42050000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 36.68}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.000123}} & 
\multicolumn{1}{|p{0.99in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.123}} \\
\hhline{-------}
%row no:4
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 1000000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 23500}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 19600000}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 38250000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 15.02}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.000299}} & 
\multicolumn{1}{|p{0.99in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.299}} \\
\hhline{-------}
%row no:5
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 1500000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 28900}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 18680000}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 35520000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 9.54}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.000471}} & 
\multicolumn{1}{|p{0.99in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.471}} \\
\hhline{-------}
%row no:6
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 2000000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 32800}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 17930000}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 33610000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 7.17}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.000627}} & 
\multicolumn{1}{|p{0.99in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.627}} \\
\hhline{-------}
%row no:7
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 2500000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 35700}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 17220000}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 32130000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 5.81}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.000775}} & 
\multicolumn{1}{|p{0.99in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.775}} \\
\hhline{-------}
%row no:8
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 3000000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 37900}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 16520000}} & 
\multicolumn{1}{|p{0.55in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 31020000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 4.95}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.000908}} & 
\multicolumn{1}{|p{0.99in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.908}} \\
\hhline{-------}
...
The \textit{battle winner reward} settles at 4.01 GOLD to 7.03 GOLD per battle depending on the DS\textit{.} This small range of reward values can be explained by the fact that all dragons are of similar DS since the players do not level up dragons and spend all DP on breeding. The exact values of the median \textit{battle winner reward }can be seen in  Table \ref{tab:Table showing the number of battles held (column 1), the corresponding dragon population (column 2), the Gold in the Treasury (column 3), the median battle winner reward (column 4), the median cost of Gold in $ (column 5), and the cost of an egg incubation (column 6).  This information is provided for the three different cases studied below. } (column 4), and Figure \ref{fig:The cost of Gold in dollars calculated as a sum of mining fees cost (light blue line), and the median battle reward in Gold versus the number of battles held (dark blue line).} (dark blue line).\par
...
The game is currently accessible via browser with a MetaMask plugin installed (\href{https://metamask.io/}{\textcolor[HTML]{1155CC}{\uline{https://metamask.io/}}}), in Opera beta mobile browser, Status (\href{https://status.im/}{\textcolor[HTML]{1155CC}{\uline{https://status.im/}}}) and Cyb (\href{https://cyb.ai/}{\textcolor[HTML]{1155CC}{\uline{https://cyb.ai/}}}).\par

No sign up or any kind of registration is\ required as in order to offer engaging gameplay no one  needs to know the names or any other personal information of the players. The private keys which are stored in the user's wallet are sufficient to serve as the players’ IDs.\par
...
The business logic layer consists of several smart contracts: an egg core features contract, a dragon core features contract, a breeding, battling and marketplace contract.\par
...
While designing the game we considered several options for the visualisation style of our dragons. The current status quo in  thecryptocollectible industry is the use of flat, simplified images which are easily merged into an image of a game character.\par

However, we decided to switch to 3/4 view as it gives a more realistic perspective to players and it makes the potential transition to VR or AR a bit easier.
...
Use of location based protocols will bring new dimensions into the Dragonereum’s gameplay. Though core game design will much likely stay unchanged, it will be possibleto create new location based game mechanics in order to utilize the power of proof-of-location protocols such as control by a dragon or a thunder of dragons over countries or territories.\\
...
During early stages of the game there is an incentive for a faster population growth, as the available  supply of Gold inflates faster than its deflation occurs (originating from the environmental costs of incubation).\par

Similar to the real world, an evergrowing population is strictly limited by available resources. Once environmental resources become scarcer deflation starts dominating over inflation thus securing the store of value for players who have managed to earn more Gold.\par

\textbf{Founders}\par

Once the smart contract is deployed, appointed team members will receive a total of 10$\%$ of tokens in their possession (shown in red in Figure \ref{fig:Chart_showing_the_allocation_of_GOLD}) in accordance with the individual contribution to the project in a form of funding, development, design, drawings, etc. conducted before Genesis.\par
...
The overall purpose of the Foundation is to stimulate the liquidity of Gold by increasing its consumption by basic protocol contracts and auxiliary contracts which return Gold to the Treasury. Examples of such contracts can be name registries, trading protocols, bridges to other networks, etc.\par
