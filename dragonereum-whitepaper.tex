...
While designing the game we considered several options for the visualisation style of our dragons. The current status quo in the cryptocollectible industry is the use of flat, simplified images which are easily merged into an image of a game character.\par
...
Use of location based protocols will bring new dimensions into the Dragonereum’s gameplay. Though core game design will much likely stay unchanged, it will be possible to create new location based game mechanics in order to utilize the power of proof-of-location protocols such as control by a dragon or a thunder of dragons over countries or territories.\\
