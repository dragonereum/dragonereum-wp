...
As already mentioned the battles described above are training battles. Those battles allow players to earn XP and Gold from the Treasury (which is one of the game’s smart contracts).\par
...
struct Tactics {
       ...
       uint8 attack; // defence/attack tactics in percentages
}
struct Fights {
       uint16 wins;
       uint16 defeats;
...
// types:
// 0 - water, 1 - fire, 2 - air, 3 - earth, 4 - magic
struct Dragon {
       uint16 generation;
       uint256[4] genome;
       uint256[2] parents;
...
mapping (uint256 => uint8) public specialDefences;
// classes:
// 0 - no skill
// 1 - attack multiplier
...
// 4 - speed multiplier
// 5 - intellect multiplier
// 6 - healing
// 7 - mana regeneration
// id -> class
mapping (uint256 => uint8) public peacefulSkills;
// classes:
// 1 - attack, 2 - defence, 3 - stamina, 4 - speed, 5 - intellect
// id -> class -> effect
...
For dragons with a mixed genome as a result of the breeding process the type used for special skills is determined during the incubation process by a factored random and stored in the type field in the specialAttacks/specialDefences mappings (see Section \ref{Blockchain breeding algorithm}).\par
...
\multicolumn{1}{p{0.78in}|}{\centering{\fontsize{10pt}{12.0pt}\selectfont Magic}} \\
\hhline{------}
%row no:2
...
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 18300}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 30880000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 35.37}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.025}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 25}} \\
\hhline{------}
%row no:4
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 1000000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 26300}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 31840000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 18.53}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.049}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 49}} \\
\hhline{------}
%row no:5
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 1500000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 31600}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 32730000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 13.24}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.068}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 68}} \\
\hhline{------}
%row no:6
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 2000000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 35600}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 33170000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 10.63}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.085}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 85}} \\
\hhline{------}
%row no:7
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 2500000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 38800}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 33490000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 9.06}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.099}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 99}} \\
\hhline{------}
%row no:8
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 3000000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 41400}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 33630000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 7.98}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.113}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 113}} \\
\hhline{------}

\end{tabular}\caption{Case Study 1: the number of battles held (column 1), the corresponding dragon population (column 2), the Gold in the Treasury (column 3), the median {\it battle winner reward} (column 4), the median cost of Gold in \$ (column 5), and the cost of an egg incubation (column 6).}
...
%row no:5
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 1500000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 17800}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 8350000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 16.51}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.055}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 55}} \\
\hhline{------}
%row no:6
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 2000000}} & 
...
In Figure \ref{fig:CS2The number of dragons (red line) as a function of the number of battles held, and the Treasury balance in Gold (black line).}, just as in Figure \ref{fig:The number of dragons (red line) as a function of the number of battles held, and the Treasury balance in GOLD (black line)} the initial sharp growth of the dragon population is due to the distribution of genesis eggs (red line). The black line shows the amount of Gold in the game’s account balance, which is declining due to the distribution of Gold to the battle winners. It will settle at approximately 6M GOLD once the number of battles held reaches 3,000,000, see also  Table \ref{tab:Same as Table 11, but for Case Study 2}, column 3.\par
...
%row no:5
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 1500000}} & 
\multicolumn{1}{|p{0.64in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 10800}} & 
\multicolumn{1}{|p{0.9in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 543000}} & 
\multicolumn{1}{|p{0.99in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 4.90}} & 
\multicolumn{1}{|p{0.94in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 0.184}} & 
\multicolumn{1}{|p{0.86in}|}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 184}} \\
\hhline{------}
%row no:6
\multicolumn{1}{|p{0.6in}}{\raggedleft {\fontsize{10pt}{12.0pt}\selectfont 2000000}} & 
...
Another 5$\%$ will be reserved for gaming studio Nonsense Games and can be used for further studio development (shown in yellow in Figure \ref{fig:Chart_showing_the_allocation_of_GOLD}). The multisig address of Nonsense Games is 0x2a52fba0c290d30214cb7876ede81c2b407e8782.\par
