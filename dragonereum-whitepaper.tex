...
\begin{center}
  \begin{equation}\label{Eq:R}
    R=\left(\frac{G}{N_d^2}\right)*I_{ds}*10*DS_f,
  \end{equation}
\end{center}

\vspace{\baselineskip}
\textit{w}here R is the \textit{battle winner reward}, G is the Gold balance in the game account, $I_{ds}$ was defined in Equation \ref{Eq:I_{ds}} above, and $DS_f$ is the \textit{dragon strength} \textit{factor} defined as,\par
...
Another 5$\%$ will be reserved for gaming studio Nonsense Games and can be used at its own discretion (shown in yellow in Figure \ref{fig:Chart_showing_the_allocation_of_GOLD}). The multisig address of Nonsense Games is 0x2a52fba0c290d30214cb7876ede81c2b407e8782.\par
