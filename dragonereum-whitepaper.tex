...
\begin{center}
  \begin{equation}\label{Eq:R}
    R=\left(\frac{G}{N_d^2}\right)*DS*10*DS_f,
  \end{equation}
\end{center}

\vspace{\baselineskip}
\textit{w}here R is the \textit{battle winner reward}, G is the Gold balance in the game account, DS was defined in Equation \ref{Eq:DS} above, and $DS_f$ is the \textit{dragon strength} \textit{factor} defined as,\par
