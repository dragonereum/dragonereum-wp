...
At game's launch we will retain the possibility to update and pause smart contracts in a case of a critical bug or game balance issues. However, once the smart contracts will be battle-tested and all necessary security measures will be taken, the control over deployed the smart contracts will be voluntarily transferred to a new owner. This might be a DAO or just the 0x000..0001 address.\par
...
\begin{itemize}
\item The Genesis eggs will be distributed in the following way:\par
...
Cybernomics of the game are based on the willingness of players to evolve better dragons in order to earn more GOLD.\par

The more dragons are battling, the more expensive it becomes to earn GOLD from the Treasury. The Treasury is guaranteed to be replenished with players GOLD payments for incubation through embedded genetics: dragons with higher DS are likely to earn more GOLD. This basic feedback loop stimulates GOLD internal liquidity.\par

Cybernomics also determines the population specifications as well: dragons are very cheap to generate at the Genesis, thus stimulating aggressive population growth in order to become dominant species in the Ethereum universe.\par

After the Genesis dragons are incentivised for rapid population growth, as available for players supply of GOLD inflates faster than deflation as a result of environmental cost of incubation.\par

So similar to real world, evergrowing population is hardly limited by available resources. Once environmental resources become more scarce deflation starts dominate over inflation thus securing the store of value for players who have managed to earn more GOLD.\par
